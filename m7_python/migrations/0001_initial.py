# Generated by Django 5.1 on 2024-09-05 01:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_inmueble', models.CharField(choices=[('casa', 'Casa'), ('bodega', 'Bodega'), ('departamento', 'Departamento'), ('parcela', 'Parcela')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pediente', 'Pendiente'), ('rechazada', 'Rechazada'), ('aprobada', 'Aprobada'), ('finalizada', 'Finalizada')], default='pendiente', max_length=50)),
